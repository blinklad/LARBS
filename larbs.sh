...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/blinklad/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/blinklad/LARBS/master/progs.csv"
